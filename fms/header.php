                ...
                <div class="mx-4">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul class="navbar-nav nav-pos">
                                <li>
                                    <a href="../">HOME<span class="line"></span></a>
                                </li>
                                <li>
                                    <a href="index.php">UNITED FMS<span class="line"></span></a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="kitchen-duct.php">Kitchen And Duct Work</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">CLEANING<span class="line"></span></a>
                                    <ul class="sub-menu">
